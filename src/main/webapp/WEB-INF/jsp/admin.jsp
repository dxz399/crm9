...
<div class="wu-sidebar" data-options="region:'west',split:true,border:true,title:'导航菜单'">
    <div class="easyui-accordion" data-options="border:false,fit:true">
        ...
        <div title="客户管理" data-options="iconCls:'icon-application-form-edit'" style="padding:5px;">
            <ul class="easyui-tree wu-side-tree">
                <li iconCls="icon-chart-organisation"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="input/cust/list" iframe="0">客户信息管理</a></li>
                <li iconCls="icon-user-group"><a href="javascript:void(0)" data-icon="icon-user-group" data-link="input/lost/list" iframe="0">客户流失管理</a></li>
            </ul>
        </div>
        ...
        <div title="统计报表" data-options="iconCls:'icon-cart'" style="padding:5px;">
            <ul class="easyui-tree wu-side-tree">
                <li iconCls="icon-arrow-nsew"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="input/rept/cons" iframe="0">客户贡献分析</a></li>
                <li iconCls="icon-arrow-in"><a href="javascript:void(0)" data-icon="icon-users" data-link="input/rept/cons" iframe="0">客户构成分析</a></li>
                <li iconCls="icon-award-star-bronze-1"><a href="javascript:void(0)" data-icon="icon-user-group" data-link="" iframe="0">客户服务分析</a></li>
                <li iconCls="icon-arrow-redo"><a href="javascript:void(0)" data-icon="icon-book" data-link="temp/layout-3.html" iframe="0">客户流失分析</a></li>
            </ul>
        </div>
...
<script type="text/javascript">
    ...
    //刷新
    function refreshByTitile(obj){
        var tab = $('#wu-tabs').tabs('getTab',obj);
        //获取选择的面板
        tab.panel('refresh');
    }
